                                            ...
                                            <div className="app_ui_content_header_right">
                                                ...
                                                </div>
                                                {
                                                    showHideComponentLoading ?
                                                        <Spinner />
                                                        :
                                                        <Switch onChange={e => handleShowHide(e.target.checked)} defaultChecked={active?.show} name="show" label="Show" />
                                                }
                                            </div>
                                        </div>
                                            ...
                                            <div className="code_content">
                                                {
                                                    (showAddPage || editCode) ?
                                                        <AddItemsForm handleDismissEdit={() => setEditCode(false)} editCode={editCode} activeTab={activeTab} handleGetCodes={handleGetCodes} componentId={active?._id} />
                                                        :
                                                        <pre>
                                                            {
                                                                activeTab &&
